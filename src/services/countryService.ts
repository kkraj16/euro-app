...
import { CountryItem, CountriesResponse } from "../slices/countries/country.fakeData";
...
export const getAllCountries = (
    ...
    if (isFakeBackend) {
        return getCountries(pageNumber, pageSize) as unknown as Promise<CountriesResponse>;
    }
