...
const ClientEdit = () => {
  ...
  const validation: any = useFormik({
    ...
    initialValues: {
      ...
      companyNumber: (client && client.companyNumber) || "",
      email: (client && client.email) || "",
      phone: (client && client.phone) || "",
      addressLine1: (client && client.addressLine1) || "",
      addressLine2: (client && client.addressLine2) || "",
      city: (client && client.city) || "",
      postcode: (client && client.postcode) || "",
      country: (client && client.country) || "",
      paymentTerms: (client && client.paymentTerms) || "",
      complianceCheckFee: (client && client.complianceCheckFee) || "",
  ...
  document.title = "Edit Client | Velzon - React Admin & Dashboard Template";
      ...
      <div className="page-content">
        <Container fluid>
          <div className="py-4 text-center">
            ...
            <div className="mt-2">Loading client...</div>
          </div>
        </Container>
      </div>
    );
